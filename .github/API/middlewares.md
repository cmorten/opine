...
```ts
import { opine, json } from "https://deno.land/x/opine@0.23.0/mod.ts";
...
```ts
import { opine, raw } from "https://deno.land/x/opine@0.23.0/mod.ts";
...
```ts
import { opine, text } from "https://deno.land/x/opine@0.23.0/mod.ts";
...
```ts
import { opine, urlencoded } from "https://deno.land/x/opine@0.23.0/mod.ts";
