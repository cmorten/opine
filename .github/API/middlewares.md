...
```ts
import { opine, raw } from "https://deno.land/x/opine@1.3.4/mod.ts";
...
```ts
import { opine, text } from "https://deno.land/x/opine@1.3.4/mod.ts";
...
```ts
import { opine, urlencoded } from "https://deno.land/x/opine@1.3.4/mod.ts";
